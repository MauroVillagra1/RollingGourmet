    ...
    <>
      <div className="aboutUs">
        ...
        <p className="mx-5 text-center fw-bolder fs-5 text mb-5">
          ...
          ordering easier. They worked together to design a friendly and secure
          interface, prioritizing the user experience. After months of effort,
          they achivieved their goal: a platform that simplifies the process of
          ordering food and drinks online, improving the lives of its users.
        </p>
