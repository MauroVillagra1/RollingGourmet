        ...
        <Col sm={12}>
          <Card className="content-card-404">
            <Card.Body className="text-light d-flex flex-column justify-content-center align-items-center">
              ...
              <img
                src="https://res.cloudinary.com/dhe7vivfw/image/upload/v1696026253/Rolling%20Gourmet/IMG%20ERROR404/image-removebg-preview_93_meqb6p.png"
                alt="hamburguer-error"
              />
