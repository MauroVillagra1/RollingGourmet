    ...
    return (
        ...
        {showComponent && (
                <div className="container_button_orders">
                    ...
                    <img src="https://res.cloudinary.com/dhe7vivfw/image/upload/v1695424758/Rolling%20Gourmet/IMG%20HOME/shopping-cart-add-button_icon-icons.com_56132_1_uvmoox.png" alt="cart" draggable="false"/>
                </div>
            )}
        </Link>
